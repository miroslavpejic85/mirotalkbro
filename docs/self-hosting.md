# Self hosting MiroTalk WebRTC Broadcast
...
![pm2](../public/assets/images/pm2.png)
...
![nginx](../public/assets/images/nginx.png)
...
Check Your MiroTalk BRO instance: https://your.domain.name

---

## Update script

In order to have Your MiroTalk BRO instance always updated to latest, we going to create a script
